			...
			<div class="card">
				<div class="card-body">
					<div class="p-4 border rounded">
						<form class="row g-3" action="{{ route('admin.provider.import.store') }}" method="POST" enctype="multipart/form-data">
						    @csrf
							...
							<div class="col-md-6">
								...
								<br>
								<center><a href="{{ asset('public/provider_sample.xlsx') }}" download>Click To Download (Sample File)</a></center>
							</div>
							<div class="col-md-3"></div>
